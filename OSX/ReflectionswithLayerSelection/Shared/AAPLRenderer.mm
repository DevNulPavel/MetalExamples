...
- (void)drawInMTKView:(nonnull MTKView *)view
{
    ...
    // Wait to ensure only MaxBuffersInFlight are getting processed by any stage in the
...

    {
        ...
        //   than necessary which could otherwise reduce our frame rate as our application, the GPU,
