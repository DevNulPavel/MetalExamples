...
/// (centerX, centerY, centerZ), with the vector (upX, upY, upZ) pointing up.  For a left-handed
//  coordinates system, negate one of eye, center, or up for right-handed)
...
/// vector pointing up (for a left-handed coordinates system, negate one vector for right-handed)
...
/// Returns quaternion for the given forward and up vectors (for a left handed coordinate system,
///   negate 'up' for right-handed)
quaternion_float AAPL_SIMD_OVERLOAD quaternion_from_direction_vectors(vector_float3 forward, vector_float3 up);

/// Returns a vector in the +Z direction for the given quaternion
vector_float3 forward_direction_vector_from_quaternion(quaternion_float q);
...
vector_float3 up_direction_vector_from_quaternion(quaternion_float q);

/// Returns a vector in the +x direction for the given quaternion (for a left handed coordinate system)
///   negate for a right-handed system)
vector_float3 right_direction_vector_from_quaternion(quaternion_float q);
