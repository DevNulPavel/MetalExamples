...
// Fragment function
fragment float4 samplingShader(RasterizerData in [[stage_in]],  // Входные данные из вершинного шейдера
                               texture2d<half> colorTexture [[texture(AAPLTextureIndexBaseColor)]]) {   // Текстура с идексом 0
    // Настройка выборки из текстуры
